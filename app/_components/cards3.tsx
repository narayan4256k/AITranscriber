...
export function FollowingPointerDemo3() {
  return (
...
const blogContent = {
  ...
  author: "Explore Library",
  date: "28th March, 2023",
  title: "Inbuilt Hymn Library",
  description:
    "Access a growing collection of ancient hymns, mantras, and sacred verses from around the world. Our built-in library makes it easy to explore, learn, and practice timeless prayers without searching elsewhere.",
  image: "./hymnlibrary.png",
